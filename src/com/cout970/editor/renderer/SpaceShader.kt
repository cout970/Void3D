...
class SpaceShader(mainVertex: String, mainFragment: String) : AbstractShaderProgram(mainVertex, mainFragment), IMatrixShader {
    ...
    lateinit var enableColor: UniformVariable
    lateinit var color: UniformVariable
    ...
    override fun getUniformLocations() {
        ...
        enableColor = getUniformLocation("enableColor")
        color = getUniformLocation("in_color")
    }
    ...
    fun enableColor() = enableColor.setBoolean(true)

    fun disableColor() = enableColor.setBoolean(false)

    fun loadColor(color: Vector3){
        this.color.setVector3(color)
    }
}